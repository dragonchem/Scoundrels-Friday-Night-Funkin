	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-pixel':
				...
				addOffset('idle', X, Y);
				addOffset("singUP", X, Y);
				addOffset("singRIGHT", X, Y);
				addOffset("singLEFT", X, Y);
				addOffset("singDOWN", X, Y);
				addOffset("singUPmiss", X, Y);
				addOffset("singRIGHTmiss", X, Y);
				addOffset("singLEFTmiss", X, Y);
				addOffset("singDOWNmiss", X, Y);
			...
			case 'b0llet':
				...
				updateHitbox();
			case 'alm':
				tex = Paths.getSparrowAtlas('characters/Alm');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24, false);
				animation.addByPrefix('singUP', 'Up', 24, false);
				animation.addByPrefix('singDOWN', 'Down', 24, false);
				...
				addOffset('idle', 0, 0);
				addOffset("singUP", -14, 56);
				addOffset("singRIGHT", -24, -58);
				addOffset("singLEFT", 21, 14);
				addOffset("singDOWN", -122, -139);
				...
				updateHitbox();
			case 'duo':
				tex = Paths.getSparrowAtlas('characters/Duo');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24, false);
				animation.addByPrefix('singUP', 'Up', 24, false);
				animation.addByPrefix('singDOWN', 'Down', 24, false);
			...
			case 'chantley':
				...
				updateHitbox();
			case 'cuttle':
				tex = Paths.getSparrowAtlas('characters/Cuttle');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24, false);
				animation.addByPrefix('singUP', 'Up', 24, false);
				animation.addByPrefix('singDOWN', 'Down', 24, false);
				...
				addOffset('idle', 0, 0);
				addOffset("singUP", 47, 44);
				addOffset("singRIGHT", -21, -10);
				addOffset("singLEFT", 53, -201);
				addOffset("singDOWN", -10, -178);
				...
				updateHitbox();
			case 'scoundrel':
				tex = Paths.getSparrowAtlas('characters/Scoundrel');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24, false);
				animation.addByPrefix('singUP', 'Up', 24, false);
				animation.addByPrefix('singDOWN', 'Down', 24, false);
				...
				addOffset('idle', 0, 0);
				addOffset("singUP", -45, 339);
				addOffset("singRIGHT", 0, -10);
				addOffset("singLEFT", 83, 250);
